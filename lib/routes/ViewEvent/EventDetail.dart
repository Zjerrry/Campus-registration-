...
class EventDetail extends StatefulWidget {
  const EventDetail({super.key, required this.EventName});
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            [
                              // 用户名
                              Text('天外天小天', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.sp,),),
                              SizedBox(width: 8.w),
                              Container(
                          ...
                          Align( // 时间底部对齐
                            ...
                            child: Text('2025-03-13 20:17:20',
          ...
          Column(
            ...
            children: [
              Column(
                children: [
                  Container(
                    ...
                    child: Text('双校区', style: TextStyle(color: Colors.white, fontSize: 11.sp, fontWeight: FontWeight.w500,),),
                  ),
                  SizedBox(height: 6.h),
                  Container(
                    padding: EdgeInsets.symmetric(horizontal: 12.w, vertical: 1.h),
                    ...
                    child: Text('进行中', style: TextStyle(color: Colors.white, fontSize: 11.sp, fontWeight: FontWeight.w500,),),
                  ),
                ],
              ),
              SizedBox(height: 6.h),
              Container(
                ...
                child: Text('#HD003514', style: Theme.of(context).textTheme.bodySmall),
              ),
                ],
              ),],),
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.access_time, size: 20), // 时钟图标
                      SizedBox(width: 6.w),
                      Text("活动时间: xxxxxx", style: TextStyle(fontSize: 12.sp)),
                    ],
                  ),
                  SizedBox(height: 5.h),
                  // 活动地点行
                  Row(
                    children: [
                      Icon(Icons.location_on_outlined, size: 20), // 位置图标
                      SizedBox(width: 6.w),
                      Text("活动地点: xxxxxx", style: TextStyle(fontSize: 12.sp)),
                    ],
                  ),
                ],
              ),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 8), // 头像与内容间距
